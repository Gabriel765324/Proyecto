...
<body>
    <?php setcookie("P_gina", 3, time() + 2222222); include("Plantilla.php"); $Nombre_del_problema = "M_ximo.php"; /*Nombre.php*/
        ...
        if(!isset($_SESSION["Temporizador"]) and isset($_SESSION["ID"])){
            ...
            if($_SESSION["Este_problema"] != $Yo){
                ...
                if(time() - 1200 >= $_SESSION["Temporizador"]){
                    ...
                    <div id="Soluci_n">
                        <h3>Solución</h3>
Use una <a href="Mesa_dispersa.php"> mesa dispersa</a> o <a href="_rbol_de_segmentos.php">árbol
de segmentos</a> para responder las consultas y guárdelas en un deque. Ordene el deque e 
imprima el resultado del medio.
                        <br>
                    </div>
                    <script>
                        function Mostrar(){
