...
<body>
    ...
    la cantidad de veces que k aparece en el arreglo a.
    <h3>Límites</h3>
    1 &le; n &le; 1000000 <br>
    1 &le; k, a<sub>i</sub> &le; 1000000000
    <h3>Ejemplo de entrada</h3>
    4 3 <br>
    1 2 3 2 5 6 1 7 45 3
    <h3>Ejemplo de salida</h3>
    2
    <h3>Explicación</h3>
    El número 3 aparece 2 veces en el arreglo a.
    <br>
    <?php
        if(!isset($_SESSION["Temporizador"]) and isset($_SESSION["ID"])){
            ...
            if($_SESSION["Este_problema"] != $Yo){
                ...
                if(time() - 1200 >= $_SESSION["Temporizador"]){
                    ...
                    <div id="Soluci_n">
                        <h3>Solución</h3>
Cree un contador e itere sobre el arreglo. Añada 1 a ese contador si a<sub>i</sub> = k.
                        <br>
                    </div>
                    <script>
                        function Mostrar(){
