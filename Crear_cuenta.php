...
<body>
    ...
    <form action="Registro22.php" method="post">
        ...
        <input type="text" name="Nombre" id="" required class="Espacio_para_poner_el_nombre_creado" maxlength="20">
        <div class="Texto_de_correo_creado">Ingrese su correo electrónico</div>
        <input type="email" name="Correo" id="" required class="Espacio_para_poner_el_correo_creado" maxlength="255">
        <div class="Texto_de_contrase_a_creada">Ingrese su contraseña</div>
        <input type="password" name="Contrase_a" id="" required class="Espacio_para_poner_la_contrase_a_creada" maxlength="20">
        <div class="Texto_de_contrase_a_creada2">Confirme su contraseña</div>
        <input type="password" name="Contrase_a2" id="" required class="Espacio_para_poner_la_contrase_a_creada2" maxlength="20">
