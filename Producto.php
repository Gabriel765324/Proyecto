...
<body>
    <?php setcookie("P_gina", 3, time() + 2222222); include("Plantilla.php"); $Nombre_del_problema = "Producto.php"; /*Nombre.php*/
        ...
        if(!isset($_SESSION["Temporizador"]) and isset($_SESSION["ID"])){
            ...
            if($_SESSION["Este_problema"] != $Yo){
                ...
                if(time() - 1200 >= $_SESSION["Temporizador"]){
                    ...
                    <div id="Soluci_n">
                        <h3>Solución</h3>
Use una <a href="Suma_de_prefijos.php">suma de prefijos</a> que guarde la multiplicación 
en lugar de la suma. No olvide usar long long porque se requiere 
incluso con <a href="Aritm_tica_modular.php">aritmética modular</a>.
                        <br>
                    </div>
                    <script>
                        function Mostrar(){
