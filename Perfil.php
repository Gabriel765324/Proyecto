...
<body>
    ...
    <form action="Editar22.php" method="post">
        ...
        <input type="text" name="Nombre" required class="Dar_nombre" maxlenght="20">
        <div class="Correo">Nuevo correo</div>
        <input type="email" name="Correo" required class="Dar_correo" maxlenght="255">
        <div class="Contrase_a">Nueva contraseña</div>
        <input type="password" name="Contrase_a" required class="Dar_contrase_a" maxlenght="20">
        <div class="Contrase_a2">Confirme su contraseña</div>
        <input type="password" name="Contrase_a2" required class="Dar_contrase_a2" maxlenght="20">
        <div class="Antigua_contrase_a">Antigua contraseña</div>
        <input type="password" name="Antigua_contrase_a" required class="Dar_antigua_contrase_a" maxlenght="20">
